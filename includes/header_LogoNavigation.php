<div class="nav-left">
	<a href="index.php"><img src="images/AgaliteLogo.png" width="209"
		height="45" border="0" class="aglogo"
		title="Home - Agalite Shower and Bath Enclosures"
		alt="Agalite Shower and Bath Enclosures" /></a>
</div>
<div class="nav-right">
	<div id="topMenu1">
		<ul id="top-level1">
	...
	<div id="topMenu2">
		<ul id="jsddm">
			...
			<li><a href="agalite-shower-doors-glass.php" title="Glass Options">Shower
					Door Glass</a></li>
			<li><a href="agalite_hardware.php" title="Agalite Hardware">Agalite
					Hardware</a></li>
