...
package {
	...
	public class VisionCollectionIntro extends MovieClip {
		...
		public function loadXML():void {
			...
			// Load the xml file.
			__loader.load(new URLRequest("Flash-XML/vision-menu.xml"));
		}
		...
		public function CollectionName():void {
			...
			tf2.x = 14;
			tf2.y = 70;
			tf2.text = "Contemporary and Practical";
			tf2.embedFonts=true;
