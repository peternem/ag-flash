...
package {
	...
	public class agalite_hardware extends MovieClip {
		...
		public function agalite_hardware() {
			loadXML();
		...
		public function loadXML():void {
			...
			__loader.load(new URLRequest("Flash-XML/agalite_hardware.xml"));// Load the xml file.
		}
		...
		public function CollectionName():void {
			...
			tf.x = 12;
			tf.y = 40;
			tf.text = "Agalite Heavy Glass Hardware";
			tf.embedFonts=true;
			...
			tf2.x = 14;
			tf2.y = 70;
			tf2.text = "Featuring Porta and Grazia Heavy Glass Hardware Collections";
			tf2.embedFonts=true;
		...
		public function mcOut(event:MouseEvent):void {
			event.target.alpha = .0;
			gotoAndStop(1);
		}
		public function mcOver(event:MouseEvent):void {
		...
		////  DPull HOTSPOT:
		public function Dpull():void {
			var square1:Sprite = new Sprite();
			square1.graphics.beginFill(fillColor);
			square1.graphics.lineStyle(1,LineColor, 100);
			square1.alpha = 0.0;
			square1.graphics.drawRect(60,255,75,75);
			square1.buttonMode=true;
			square1.addEventListener(MouseEvent.CLICK, onClick1);
			square1.addEventListener(MouseEvent.ROLL_OVER, mcOver);
			square1.addEventListener(MouseEvent.ROLL_OUT, mcOut);
			square1.name = "Dpull";
			square1.filters = [getBitmapFilter()];
			addChild(square1);

			//// BUTTON TWEEN USED TO SHOW USER WERE HOTSPOTS ARE LOCATED
//			var AlphaTween1:Tween = new Tween(square1, "alpha", None.easeInOut, TweenIn, 0, TwDuration, true);
//			AlphaTween1.addEventListener( TweenEvent.MOTION_FINISH, DoFadeOut1 );
//			
//			function DoFadeOut1(e:TweenEvent):void {
//				var AlphaTween:Tween = new Tween(square1, "alpha", None.easeInOut, TweenOut, 0, TwDuration, true);
//			}
		}
		////  WallMount HOTSPOT:
		public function WallMount():void {
			var square2:Sprite = new Sprite();
			square2.graphics.beginFill(fillColor);
			square2.graphics.lineStyle(1,LineColor, 100);
			square2.alpha = 0.0;
			square2.graphics.drawRect(0,115,75,75);
			square2.buttonMode=true;
			square2.addEventListener(MouseEvent.CLICK, onClick1);
			square2.addEventListener(MouseEvent.ROLL_OVER, mcOver);
			square2.addEventListener(MouseEvent.ROLL_OUT, mcOut);
			square2.name = "WallMount";
			square2.filters = [getBitmapFilter()];
			addChild(square2);

			//// BUTTON TWEEN USED TO SHOW USER WERE HOTSPOTS ARE LOCATED
//			var AlphaTween2:Tween = new Tween(square2, "alpha", None.easeInOut, TweenIn, 0, TwDuration, true);
//			AlphaTween2.addEventListener( TweenEvent.MOTION_FINISH, DoFadeOut2 );
//			
//			function DoFadeOut2(e:TweenEvent):void {
//				var AlphaTween2:Tween = new Tween(square2, "alpha", None.easeInOut, TweenOut, 0, TwDuration, true);
//			}
		}

		////  SleeveOver HOTSPOT:
		public function SleeveOver():void {
			var square3:Sprite = new Sprite();
			square3.graphics.beginFill(fillColor);
			square3.graphics.lineStyle(1,LineColor, 100);
			square3.alpha = 0.0;
			square3.graphics.drawRect(280,52,75,75);
			square3.buttonMode=true;
			square3.addEventListener(MouseEvent.CLICK, onClick1);
			square3.addEventListener(MouseEvent.ROLL_OVER, mcOver);
			square3.addEventListener(MouseEvent.ROLL_OUT, mcOut);
			square3.name = "SleeveOver";
			square3.filters = [getBitmapFilter()];
			addChild(square3);

			//// BUTTON TWEEN USED TO SHOW USER WERE HOTSPOTS ARE LOCATED
//			var AlphaTween3:Tween = new Tween(square3, "alpha", None.easeInOut, TweenIn, 0, TwDuration, true);
//			AlphaTween3.addEventListener( TweenEvent.MOTION_FINISH, DoFadeOut3 );
//
//			function DoFadeOut3(e:TweenEvent):void {
//				var AlphaTween3:Tween = new Tween(square3, "alpha", None.easeInOut, TweenOut, 0, TwDuration, true);
//			}
		}
		/**
		 * Draw the menu. 
