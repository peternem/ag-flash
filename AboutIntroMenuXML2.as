...
package {
	...
	public class AboutIntroMenuXML2 extends MovieClip {
		...
		public function loadXML():void {
			...
			// Load the xml file.
			__loader.load(new URLRequest("Flash-XML/aboutIntro-menu.xml"));
		}
		...
		public function CollectionName():void {
			...
			tf2.x = 14;
			tf2.y = 50;
			tf2.text = "Designing, Manufacturing And Selling Shower & Bath Enclosures Since The 1950's.";
		...
		public function pinstripe():void {
			...
			pinstripeBot.graphics.drawRect(0,194,800,6);
