...
package {
	...
	public class resourcesIntroMenuXML extends MovieClip {
		public var __menuList:XMLList;// Create an XML list to hold the buttons.
		public var __loader:URLLoader;// External file loader.
		public var url:String = "images/resourcesIntro.jpg";//// HG102307_0063-2.jpg //HG102307_0063.jpg
		public var urlRequest:URLRequest = new URLRequest(url);

		public function resourcesIntroMenuXML() {
		...
		public function loadXML():void {
			...
			// Load the xml file.
			__loader.load(new URLRequest("Flash-XML/resources-menu.xml"));
		}
		...
		public function CollectionName():void {
			...
			tf2.x = 14;
			tf2.y = 70;
			tf2.text = "A Variety Of Resources To Help Inform, Support And Maintain Agalite Shower Enclosures.";
